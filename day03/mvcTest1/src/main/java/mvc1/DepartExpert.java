...
public class DepartExpert {
    public List<String> getAdvice(String depart) {
        ...
        switch (depart){
            case "c":
                list.add("벨 연구소에서 개발한 프로그래밍 언어");
                list.add("프로그램을 간결하게 쓸 수 있다.");
                list.add("프로그래밍 하기에 쉽고 편리한 언어이다.");
                break;
            case "java":
                list.add("객체지향 프로그래밍 언어입니다.");
                list.add("네트워크 기능의 구현이 용이하여 인터넷 환경에서 많이 사용하는 언어");
                list.add("보안성이 뛰어나며 컴파일한 코드는 다른 언어에서 사용이 가능하다.");
                break;
            case "python":
                list.add("간결하고 생산성이 높은 프로그래밍 언어입니다.");
