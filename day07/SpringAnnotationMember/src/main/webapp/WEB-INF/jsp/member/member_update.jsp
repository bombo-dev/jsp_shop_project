	...
	<form name="f" action="member_update.do" 
		...
		<table border="1" width="80%">
			...
			<tr>
				...
				<td><input type="text" name="ssn1" value="${dto.ssn1}" readOnly>
					- <input type="password" name="ssn2" value="${dto.ssn2}" readOnly></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="hp1" size="3" maxlength="3" value="${dto.hp1}">
					-<input type="text" name="hp2" size="4" maxlength="4" value="${dto.hp2}">
					-<input type="text" name="hp3" size="4" maxlength="4" value="${dto.hp3}"></td>
			</tr>
			<tr>
